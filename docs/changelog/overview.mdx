...
<Update label="2026-02-06" description="v0.42">
### New Features

- **Claude Opus 4.6**: Added support for Anthropic's Claude Opus 4.6 model
- **Branch merge node**: New workflow node to merge parallel branches
- **Notion Webhook trigger**: Start workflows from Notion with webhook triggers

### Improvements

- **Message compaction**: More efficient handling of long conversations in workflows
- **Tool error handling**: Clearer handling and reporting when tools fail

### Bug Fixes

- **Monitor UI**: Resolved display issues on the monitor page
- **Code node**: Fixed output extraction from code nodes
- **Document processing**: Fixed latency issues when processing large PDFs
