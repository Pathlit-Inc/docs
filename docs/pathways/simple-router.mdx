...
- **Model**:
  ...
  {" "}
  <Tip>
    Use a small (Llama 3.1 7B) or cheap (GPT4o) models for simple decisions and
    a larger model (GPT4, Claude 3.5) for more complex routing logic.
  </Tip>
...
- **Temperature**:
  ...
  {" "}
  <Tip>Reduce the temperature to 0 for a completely deterministic output.</Tip>
...
<CardGroup>
  <Card title="Language Model Node" href="/docs/pathways/llm">
