...
- **Version 1.1.0 Update**:
  ...
  The method for updating global variables has been optimized. Use the `org.update` method for more efficient updates, replacing the previous `Organization.find_one(Organization.id == org_id).update` method.
