...
Note that you must have **_administrator privileges_** within your Jira domain to create a permissible API token.
...
{" "}
<Card title="Output Node" href="/docs/pathways/output">
