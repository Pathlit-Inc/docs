...
**Version 1.0.1 Update**: This version includes improvements in agent initialization and tool registration, enhancing the efficiency and reliability of interactions with the Bitbucket API.
