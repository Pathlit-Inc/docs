...
If you encounter any issues with the Airtable Input Node that are not covered in this documentation, please reach out to our support team for assistance. [Contact Support](https://pathlit.ai/contact)
...
<CardGroup>
  <Card
    ...
    href="/docs/pathways/airtable-out"
  >
    Explore how to export data back to Airtable.
  </Card>

{" "}
<Card title="Google Drive Input Node" href="/docs/pathways/google-drive-input">
  Import files and data from Google Drive into your workflow.
</Card>

{" "}
<Card title="Web Extract Node" href="/docs/pathways/web-extract">
