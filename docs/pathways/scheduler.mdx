...
<Note>
  One of the two options, either Datetime or Cron, must be selected to trigger
  the workflow. You cannot choose to use both options simultaneously.
</Note>
...
<CardGroup>
  <Card title="Input Node" href="/docs/pathways/input">
