...
<CardGroup>
  <Card title="Airtable Input Node" href="/docs/pathways/airtable-in">
    Import data from Airtable into your workflow
  </Card>
  <Card title="Airtable Output Node" href="/docs/pathways/airtable-out">
    Explore the possibilities of Pathlit
  </Card>
  <Card title="Gmail Send Node" href="/docs/pathways/gmail-send">
