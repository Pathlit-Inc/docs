...
<CardGroup>
  ...
  <Card title="LinkedIn Scraper Agent Node" href="/docs/pathways/linkedin-scraper-agent-node">
    Scrape LinkedIn posts, profiles, and companies using specified tools and models
  </Card>
