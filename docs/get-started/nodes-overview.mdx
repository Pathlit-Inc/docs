...
<CardGroup>
  ...
  <Card title="Pull Request Access Node" href="/docs/pathways/pull-request-access-node">
    Handle access issues related to specific commits or branches in a pull request
  </Card>
